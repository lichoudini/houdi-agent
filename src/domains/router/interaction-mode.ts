...
function hasOperationalNoun(normalizedText: string): boolean {
  return /\b(workspace|archivo|carpeta|correo|gmail|email|mail|recordatorio|tarea|web|internet|noticia|noticias|documento|pdf|csv|json|html|skill|habilidad|regla)\b/.test(
    normalizedText,
  );
}
